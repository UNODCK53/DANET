<?php
	...
	Fpdf::Cell(100,10,"La Unidad de Informacion certifica el siguiente numero de procesos");//.$campodb['nombre']);
	...
	Fpdf::Ln(10);
	Fpdf::Cell(100,10,"Hora de elaboracion de Informe: ".date("H:i"));//.$campodb['ordenador']);
