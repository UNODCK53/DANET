...
<!--tercer contenedor pie de página-->
  <div class="container" id="sha">
      ...
      <!--Texto del contenido-->
        ...
        <div class="col-sm-10">
            <h1 class="text-center text-primary">Metodología Para La Validación Y Certificación De La Erradicación Manual Forzosa</h1>
            ...
            <ul class="lead text-justify" ><span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:#337ab7"></span> Diseño de los formularios de recolección de información: UNODC diseña e implementa la captura digital a través herramientas basadas en dispositivos móviles (Open Data Kit –ODK-, GeoODK, ArcGIS Online) los formularios de captura de información en campo, basado en las funcionalidades requeridas por UACT y GME.</ul>
            <ul class="lead text-justify" ><span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:#337ab7"></span> Configuración de equipos GPS: UNODC configura los equipos de captura GPS, instalando las aplicaciones requeridas para el buen funcionamiento del aplicativo para la captura de información establecido.</ul>
            <ul class="lead text-justify" ><span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:#337ab7"></span> Recolección de información en campo: proceso durante el cual los GME documentan  las áreas erradicadas en su dispositivo GPS, formulario digital en dispositivo móvil y en carteras de campo. Los monitores de UNODC de acuerdo con la programación de las zonas y disponibilidad de imágenes satelitales hacen presencia en el terreno para documentar el avance de la erradicación y la calidad en la captura de la información.</ul>
            <ul class="lead text-justify" ><span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:#337ab7"></span> Transferencia y crítica de la información: la información capturada en terreno es transferida por UACT a la oficina de UNODC a través de la red de internet o tarjeta física y se consigna en un registro de transferencia para luego ser concertada con la Oficina Administrativa de Planeación y Gestión de la Información – OAPGI/UACT.</ul>
            <ul class="lead text-justify" ><span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:#337ab7"></span> Estructuración de los polígonos delimitados en campo: proceso durante el cual los polígonos capturados en campo son editados para corregir errores topológicos y de captura debido a la variación de la señal GPS o recorrido del profesional en el terreno. De este proceso se deriva el archivo final de áreas de erradicación en formato shapefile que será entregado a OAPGI/DPCI/UACT.</ul>
            ...
            <ul class="lead text-justify" ><span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:#337ab7"></span> Expansión de los resultados por municipio y punto de erradicación: aplicación de métodos de muestreo para llevar los resultados de verificación de la muestra a un estimativo, a escala de la Fase, del área erradicada por núcleo y departamento.</ul>
