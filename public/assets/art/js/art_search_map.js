...
function search(cod,mpio, depto){	
	...
	var texto='<div class="col-xs-12 col-sm-6 col-md-2"><a target="_blank" href="assets/art/documentos/Infografias/DNP/'+cod+'.pdf"><img src="assets/art/img/dnp.png" alt="No images" class="img-rounded" style="height: 150px"></a></div> <div class="col-xs-12 col-sm-6 col-md-2"><a target="_blank" href="assets/art/documentos/Infografias/detallada/'+cod+'.pdf"><img src="assets/art/img/detallada.png" alt="No images" class="img-rounded" style="height: 150px"></a></div>    <div class="col-xs-12 col-sm-6 col-md-2"><a target="_blank" href="assets/art/documentos/Infografias/Social/'+cod+'.pdf"><img src="assets/art/img/social.png" alt="No images" class="img-rounded"></a></div><div class="col-xs-12 col-sm-6 col-md-2"><a target="_blank" href="assets/art/documentos/Infografias/Inversion/'+cod+'.pdf"><img src="assets/art/img/inversion.png" alt="No images" class="img-rounded"></a></div><div class="col-xs-12 col-sm-6 col-md-2"><a target="_blank" href="assets/art/documentos/Infografias/ZVT/'+cod+'.pdf"><img src="assets/art/img/zv.png" alt="No images" class="img-rounded"></a></div><div class="col-xs-12 col-sm-6 col-md-2"><a target="_blank" href="assets/art/documentos/Infografias/Mapas/'+cod+'.pdf"><img src="assets/art/img/mapa.png" alt="No images" class="img-rounded"></a></div>'
	$("#avance").show();
	$('#titulo').html(tittle)
